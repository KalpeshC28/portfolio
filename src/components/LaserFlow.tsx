...
// ...full fragment shader code from your previous message...
`;
...
// ...existing code...
// (Paste the full LaserFlow implementation here, including VERT, FRAG, and the React component logic)

// (Full LaserFlow component code pasted here)

// --- Begin LaserFlow code ---

// ...[VERT, FRAG, LaserFlow component code as provided above]...
